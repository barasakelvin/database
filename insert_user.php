...
// Escape special characters.
        ...
        $phonenum = mysqli_real_escape_string($db_connection, htmlspecialchars($_POST['phonenum']));
...
// INSER USER INTO THE DATABASE
                $insert_user = mysqli_query($db_connection, "INSERT INTO `users` (username, user_email, user_password,Phonenumber) VALUES ('$username', '$user_email', '$user_hash_password','$phonenum')");
